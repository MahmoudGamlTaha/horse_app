       ...
       <table class="table box table-bordered">
        ...
        <tr>
          <td colspan="3">  
            <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#addNewUOF"  rel="tooltip" data-original-title="" title="Add new item"><i class="fa fa-plus"></i> <?php echo e(trans('language.attribute.add_more'), false); ?></button>
 ...
 //    return;
  ...
  $.ajax({
    ...
    beforeSend:function(xhr, type) {
              if (!type.crossDomain) {
                 xhr.setRequestHeader('X-CSRF-Token','<?php echo e(csrf_token(), false); ?>');
               }},
