                ...
                <div class="col-sm-4 col-sm-offset-1">
                    <div class="login-form"><!--login form-->
                        ...
                        <form action="<?php echo e(route('postLogin'), false); ?>" method="post"  class="box">
                            ...
                            <div class="form-group<?php echo e($errors->has('company') ? ' has-error' : '', false); ?>">
                                <label for="company" class="control-label">Your Company</label>
                                    <input class="is_required validate account_input form-control <?php echo e(($errors->has('company'))?"input-error":"", false); ?>"   type="text" name="company" value="<?php echo e(old('company'), false); ?>" >
                                        <?php if($errors->has('company')): ?>
                                            <span class="help-block">
                                                <?php echo e($errors->first('company'), false); ?>
