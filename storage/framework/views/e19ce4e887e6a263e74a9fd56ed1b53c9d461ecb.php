                ...
                <tbody>
                  ...
                  <?php $__currentLoopData = $dataList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                      ...
                      <td ><a href="#" class="updateData_num"   data-name="fee" data-type="text" data-pk="<?php echo e($dataList['id'], false); ?>" data-url="<?php echo e(route('processExtension',['group'=>'shipping','key'=>'ShippingStandard']), false); ?>" data-title="<?php echo e(trans('Extensions/Shipping/ShippingStandard.fee'), false); ?>"><?php echo e($dataList['fee'], false); ?></a></td>
                      <td><a href="#" class="updateData_num" data-name="shipping_free" data-type="text" data-pk="<?php echo e($dataList['id'], false); ?>" data-url="<?php echo e(route('processExtension',['group'=>$group,'key'=>$key]), false); ?>" data-title="<?php echo e(trans('Extensions/Shipping/ShippingStandard.shipping_free'), false); ?>"><?php echo e($dataList['shipping_free'], false); ?></a></td>
