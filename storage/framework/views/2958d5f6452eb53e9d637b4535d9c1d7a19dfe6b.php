...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo e(admin_base_path('auth/login'), false); ?>" method="post">
      ...
      <div class="form-group has-feedback <?php echo !$errors->has('company') ?: 'has-error'; ?>">

        <?php if($errors->has('company')): ?>
          <?php $__currentLoopData = $errors->get('company'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i><?php echo e($message, false); ?></label><br>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>

        <input type="text" class="form-control" placeholder="<?php echo e(trans('admin.company'), false); ?>" name="company" value="<?php echo e(old('company'), false); ?>">
