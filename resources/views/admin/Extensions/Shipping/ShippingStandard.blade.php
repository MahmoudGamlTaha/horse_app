                ...
                <tbody>
                  ...
                  @foreach($dataList as $data)
                    ...
                    <tr>
                      ...
                      <td ><a href="#" class="updateData_num"   data-name="fee" data-type="text" data-pk="{{ $dataList['id'] }}" data-url="{{ route('processExtension',['group'=>'shipping','key'=>'ShippingStandard']) }}" data-title="{{ trans('Extensions/Shipping/ShippingStandard.fee') }}">{{ $dataList['fee'] }}</a></td>
                      <td><a href="#" class="updateData_num" data-name="shipping_free" data-type="text" data-pk="{{ $dataList['id'] }}" data-url="{{ route('processExtension',['group'=>$group,'key'=>$key]) }}" data-title="{{ trans('Extensions/Shipping/ShippingStandard.shipping_free') }}">{{ $dataList['shipping_free'] }}</a></td>
